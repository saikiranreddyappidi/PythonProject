"""customerId,customerName,phoneNumber,city,unitsConsumed,costPerUnit
a)the system should be able to calculate the Electricity Bill based on the units consumed and cost per unit for
 a particular customer
b)display the customer having less unitsConsumed
c)display the details of the customer based on customerId
d)display the phone number based on customerName
"""
